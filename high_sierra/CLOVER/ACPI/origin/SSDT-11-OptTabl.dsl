 ...
 *
 * Disassembly of SSDT-11-OptTabl.aml, Sat Aug 31 20:06:28 2019
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001CF7 (7415)
 *     Revision         0x01
 *     Checksum         0xF5
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_PR_.CPU0.CPPC, IntObj)    // (from opcode)
    External (_PR_.CPU1.CPPC, IntObj)    // (from opcode)
    External (_PR_.CPU2.CPPC, IntObj)    // (from opcode)
    External (_PR_.CPU3.CPPC, IntObj)    // (from opcode)
    External (_PR_.CPU4.CPPC, IntObj)    // (from opcode)
    External (_PR_.CPU5.CPPC, IntObj)    // (from opcode)
    External (_PR_.CPU6.CPPC, IntObj)    // (from opcode)
    ...
    External (_SB_.PCI0.GGPI, MethodObj)    // 4 Arguments (from opcode)
    External (_SB_.PCI0.LPCB.EC__.TCPU, UnknownObj)    // (from opcode)
    ...
    External (_SB_.PCI0.PEG0.LNKD, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.PEG0.LNKS, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.PEG0.LREN, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.PEG0.LTRE, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.PEG0.PEGP, DeviceObj)    // (from opcode)
    External (_SB_.PCI0.PEG0.PEGP._ADR, DeviceObj)    // (from opcode)
    External (_SB_.PCI0.PEG0.PEGP.LRBF, UnknownObj)    // (from opcode)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        {
            Store ("<<< GC6I >>>", Debug)
            Store (\_SB.PCI0.PEG0.LREN, \_SB.PCI0.PEG0.PEGP.LRBF)
            Store (One, \_SB.PCI0.PEG0.LNKD)
            While (LNotEqual (\_SB.PCI0.GGPI (SGGP, Zero, 0x01050017, One), One))
            {
                Sleep (One)
            }
        ...
        Method (GC6O, 0, Serialized)
        {
            ...
            \_SB.PCI0.SGPO (SGGP, Zero, 0x0105000E, Zero, One)
            While (LNotEqual (\_SB.PCI0.GGPI (SGGP, Zero, 0x01050017, One), Zero))
            {
                Sleep (One)
            }

            \_SB.PCI0.SGPO (SGGP, Zero, 0x0105000E, Zero, Zero)
            While (LLess (\_SB.PCI0.PEG0.LNKS, 0x07))
            {
                Sleep (One)
            }

            Store (\_SB.PCI0.PEG0.PEGP.LRBF, \_SB.PCI0.PEG0.LREN)
            Store (One, \_SB.PCI0.PEG0.CEDR)
        }

        Method (GETS, 0, Serialized)
        {
            If (LEqual (\_SB.PCI0.GGPI (SGGP, Zero, 0x01050017, One), Zero))
            {
                    ...
                    Switch (PSH0)
                    {
                        Case (Zero)
                        {
                            If (CPUT)
                            {
                                Store (0x0200, RETN)
                                Or (RETN, PSH0, RETN)
                                Store (\_SB.PCI0.LPCB.EC.TCPU, PDTS)
                            }
